...
class Team extends Component {
	...
	render() {
		...
		return (
			<tr>
				<td className="text-center">{this.props.team.rank}</td>
				<td className="text-center"><span className="small">{this.props.team.rankLast10}</span></td>
				<td className="text-right">{this.props.team.rankDivision}</td>
				<td className="text-right"><span className="small">{this.props.team.streak}</span></td>
				<td><img src={Functions.getLogo(this.props.team.id)} alt="" title={this.props.team.id} /> {this.state.name} <span className="small">({this.props.team.wins}-{this.props.team.losses}-{this.props.team.ot})</span></td>
				<td><span className="small">{this.props.team.goalsScored}-{this.props.team.goalsAgainst}</span></td>
